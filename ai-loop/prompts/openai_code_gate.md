...
- Do **not** invent details. You are critiquing based on the provided git diff and test results.
- If any **Automatic Blocker** condition is present, you MUST set:
  - `approved: false`
  - `confidence <= 96`
- Blockers must be **specific and actionable** and include an evidence pointer (file:line or test output snippet).
